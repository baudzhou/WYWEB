...
class Task:
        ...
        def partial_class(*wargs, **kwargs):
            ...
            if self.custom_model_class is not None:
                model = self.custom_model_class(
                    model_config, model, num_labels=kwargs["num_labels"]
                )
            return model
    ...
    def add_arguments(cls, parser):
        ...
        parser.add_argument(
            ...
            type=str,
            default=None,
            help="An example task specific argument",
        )
